...
This library is provided **"AS IS"**, without warranty of any kind. While it has been designed with enterprise-grade patterns (Circuit Breakers, Singleflight, etc.) to ensure high availability, caching in distributed systems is inherently complex.

The authors and contributors of this project assume **no responsibility or liability** for any potential data loss, cache inconsistencies, system crashes, or financial damages resulting from the use or misuse of this software in production environments. Please thoroughly test the library in your specific infrastructure, configure the Circuit Breaker and memory limits carefully, and review the code before deploying it to production.
